...
import {
  ...
  consultaActivarProducto,
  consultaDesactivarProducto,
      ...
      <Card className="pt-0 cardItemProducto">
        ...
        <Card.Body className="cardBodyProducto shadow">
                ...
                <Form.Check
                  ...
                  label={
                    botonSwitch ? (
                      ...
                      <span className="textoSpan letraRoboto">Inactivo</span>
                    )
                  }
                ></Form.Check>
              </Form>
          ...
          <Card.Text className="letraRoboto">
            <strong className="letraSpace">Categoría:</strong>
            {producto.categoria}
            <br />
          ...
          <section className="letraRoboto d-flex flex-row justify-content-evenly pb-2">
            <aside>
              <Button
                as={Link}
                to={`/administrar/productos/editar-producto/${producto._id}`}
            ...
            <aside>
              <Button className="btnBorrarProducto" onClick={borrarUnProducto}>
                Borrar
              </Button>
            </aside>
          </section>
