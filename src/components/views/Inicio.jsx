...
const Inicio = ({ usuarioLogueado, setusuarioLogueado, carrito, setCarrito, usuario }) => {
      ...
      <Container>
        ...
        <Row className="justify-content-around menu">
          {productos.map((producto) => (
            <CardProducto key={producto._id} producto={producto} carrito={carrito} setCarrito={setCarrito} usuario={usuario} ></CardProducto>
          ))}
        </Row>
      </Container>
    </section>
